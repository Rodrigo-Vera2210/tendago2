...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class SecuencialEntity : SecuencialEntityBase
    
    {
        ...
        public SecuencialEntity Copy()
        {
          SecuencialEntity copy = CopyBase();
        ...
        {
            return $"{this.Ruc} {this.IdTipoDocumento} {this.Establecimiento} {this.PuntoVenta}";
        }
