...
namespace ER.BE
{
    ...
    public partial class UsuarioLocalBodegaFindParameterEntity
    {
		...
		private string _inicioSesion_DisplayMember;
		private int _idLocalBodega = int.MinValue;
		private string _idLocalBodega_DisplayMember;
		...
		public string InicioSesion_DisplayMember
		{
			get
			{
				return _inicioSesion_DisplayMember;
			}
			set
			{
				_inicioSesion_DisplayMember = value;
			}
		}

		public int IdLocalBodega
		{
			get
			{
		...
		public string IdLocalBodega_DisplayMember
		{
			get
			{
				return _idLocalBodega_DisplayMember;
			}
			set
			{
				_idLocalBodega_DisplayMember = value;
			}
		}
        ...
        public bool IsValid(UsuarioLocalBodegaEntity _entity)
        { 
			if(!String.IsNullOrEmpty(this.InicioSesion))
			{
				if(this.InicioSesion!=_entity.InicioSesion)
				{
					return false;
				}
			}

			if(this.IdLocalBodega != int.MinValue)
			{
				if(this.IdLocalBodega!=_entity.IdLocalBodega)
				{
					return false;
				}
			}
