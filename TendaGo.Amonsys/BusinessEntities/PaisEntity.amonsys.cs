...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class PaisEntityBase : EntityStatesManager
    
    {
		...
		public const string CodigoNacionalidad_EntityColumn = "CodigoNacionalidad";
		...
		/// <summary> 
		/// Get or sets a optional value of Nacionalidad. 
		/// </summary>
		...
		/// <summary> 
		/// Get or sets a optional value of CodigoNacionalidad. 
		/// </summary>
		public virtual string CodigoNacionalidad
		{
			get
			{
			...
			set
			{
				if (_codigoNacionalidad != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
        ...
        public PaisEntityBase ()
        {
            SetNewState();
        }
        
        
        internal PaisEntity CopyBase()
        {
          PaisEntity copy = new PaisEntity();
          copy.Id = this.Id;
          copy.Codigo = this.Codigo;
          copy.Pais = this.Pais;
          copy.Nacionalidad = this.Nacionalidad;
          copy.CodigoNacionalidad = this.CodigoNacionalidad;
...
#region << Children >>
		...
		private EntidadEntityCollection _EntidadFromIdPais;

		public virtual EntidadEntityCollection EntidadFromIdPais
		{
			get
			{
				return _EntidadFromIdPais;
			}
			set
			{
				_EntidadFromIdPais = value;
			}
		}

		private MonedaEntityCollection _MonedaFromPais;

		public virtual MonedaEntityCollection MonedaFromPais
		{
			get
			{
				return _MonedaFromPais;
			}
			set
			{
				_MonedaFromPais = value;
			}
		}

		private ProvinciaEntityCollection _ProvinciaFromIdPais;

		public virtual ProvinciaEntityCollection ProvinciaFromIdPais
		{
			get
			{
				return _ProvinciaFromIdPais;
			}
			set
			{
				_ProvinciaFromIdPais = value;
			}
		}
