...
{
	[System.Serializable]
	public partial class SerieEntradaEntity : SerieEntradaEntityBase
	{
		...
		public SerieEntradaEntity Copy()
		{
			SerieEntradaEntity copy = CopyBase();
	...
	[System.Serializable]
	public partial class SerieEntradaEntityBase : EntityStatesManager
	{
		#region << Columns >>
		public const string Id_EntityColumn = "Id";
		public const string IdDetalleEntrada_EntityColumn = "IdDetalleEntrada";
		...
		/// </summary>
		public virtual string IdDetalleEntrada
		{
			get
			{
			...
			set
			{
				if (_idDetalleEntrada != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
		...
		public SerieEntradaEntityBase()
		{
			SetNewState();
		}


		internal SerieEntradaEntity CopyBase()
		{
			SerieEntradaEntity copy = new SerieEntradaEntity();
			copy.Id = this.Id;
			copy.IdDetalleEntrada = this.IdDetalleEntrada;
