...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class TipoDocumentoEntityBase : EntityStatesManager
    
    {
		...
		public const string TipoDocumento_EntityColumn = "TipoDocumento";
		...
		/// <summary> 
		/// Get or sets a obligatory value of TipoDocumento. 
		/// </summary>
		public virtual string TipoDocumento
		{
			...
			set
			{
				if (_tipoDocumento != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
        ...
        public TipoDocumentoEntityBase ()
        {
            SetNewState();
        }
        
        
        internal TipoDocumentoEntity CopyBase()
        {
          TipoDocumentoEntity copy = new TipoDocumentoEntity();
          copy.Id = this.Id;
          copy.TipoDocumento = this.TipoDocumento;
...
#region << Children >>
		...
		private DocumentoEntityCollection _DocumentoFromIdTipoDocumento;

		public virtual DocumentoEntityCollection DocumentoFromIdTipoDocumento
		{
			get
			{
				return _DocumentoFromIdTipoDocumento;
			}
			set
			{
				_DocumentoFromIdTipoDocumento = value;
			}
		}
