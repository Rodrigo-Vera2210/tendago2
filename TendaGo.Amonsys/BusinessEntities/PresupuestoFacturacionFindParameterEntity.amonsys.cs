...
namespace ER.BE
{
    ...
    public partial class PresupuestoFacturacionFindParameterEntity
    {
		...
		private decimal _presupuesto = decimal.MinValue;
        ...
        public bool IsValid(PresupuestoFacturacionEntity _entity)
        { 
			...
			if(this.Presupuesto != decimal.MinValue)
			{
				if(this.Presupuesto!=_entity.Presupuesto)
				{
					return false;
				}
			}
