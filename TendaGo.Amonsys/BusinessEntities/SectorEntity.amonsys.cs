...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class SectorEntityBase : EntityStatesManager
    
    {
		...
		public const string Sector_EntityColumn = "Sector";
		...
		/// <summary> 
		/// Get or sets a obligatory value of Sector. 
		/// </summary>
		public virtual string Sector
		{
			...
			set
			{
				if (_sector != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
				_sector = value;
        ...
        public SectorEntityBase ()
        {
            SetNewState();
        }
        
        
        internal SectorEntity CopyBase()
        {
          SectorEntity copy = new SectorEntity();
          copy.Id = this.Id;
...
#region << Children >>
		...
		private EntidadEntityCollection _EntidadFromIdSector;

		public virtual EntidadEntityCollection EntidadFromIdSector
		{
			get
			{
				return _EntidadFromIdSector;
			}
			set
			{
				_EntidadFromIdSector = value;
			}
		}
