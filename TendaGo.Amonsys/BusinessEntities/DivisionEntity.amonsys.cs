...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class DivisionEntityBase : EntityStatesManager
    
    {
		...
		public const string Division_EntityColumn = "Division";
		...
		/// <summary> 
		/// Get or sets a obligatory value of Division. 
		/// </summary>
		public virtual string Division
		{
			...
			set
			{
				if (_division != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
				_division = value;
        ...
        public DivisionEntityBase ()
        {
            SetNewState();
        }
        
        
        internal DivisionEntity CopyBase()
        {
          DivisionEntity copy = new DivisionEntity();
          copy.Id = this.Id;
...
#region << Children >>
		...
		private LineaEntityCollection _LineaFromIdDivision;

		public virtual LineaEntityCollection LineaFromIdDivision
		{
			get
			{
				return _LineaFromIdDivision;
			}
			set
			{
				_LineaFromIdDivision = value;
			}
		}

		private ProductoEntityCollection _ProductoFromIdDivision;

		public virtual ProductoEntityCollection ProductoFromIdDivision
		{
			get
			{
				return _ProductoFromIdDivision;
			}
			set
			{
				_ProductoFromIdDivision = value;
			}
		}
