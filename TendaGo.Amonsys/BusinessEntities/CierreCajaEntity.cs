...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class CierreCajaEntity : CierreCajaEntityBase
    
    {
        ...
        public CierreCajaEntity Copy()
        {
          CierreCajaEntity copy = CopyBase();
        ...
        {
            return $"{Id} {FechaCierre} {IdCajero} {Observaciones}";
        }
