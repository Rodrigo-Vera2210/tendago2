...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class PerfilEntityBase : EntityStatesManager
    
    {
		...
		public const string Perfil_EntityColumn = "Perfil";
		...
		/// <summary> 
		/// Get or sets a obligatory value of Perfil. 
		/// </summary>
		public virtual string Perfil
		{
			...
			set
			{
				if (_perfil != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
				_perfil = value;
        ...
        public PerfilEntityBase ()
        {
            SetNewState();
        }
        
        
        internal PerfilEntity CopyBase()
        {
          PerfilEntity copy = new PerfilEntity();
          copy.Id = this.Id;
          copy.Perfil = this.Perfil;
...
#region << Children >>
		...
		private PantallaXPerfilEntityCollection _PantallaXPerfilFromIdPerfil;

		public virtual PantallaXPerfilEntityCollection PantallaXPerfilFromIdPerfil
		{
			get
			{
				return _PantallaXPerfilFromIdPerfil;
			}
			set
			{
				_PantallaXPerfilFromIdPerfil = value;
			}
		}

		private UsuarioEntityCollection _UsuarioFromIdPerifl;

		public virtual UsuarioEntityCollection UsuarioFromIdPerifl
		{
			get
			{
				return _UsuarioFromIdPerifl;
			}
			set
			{
				_UsuarioFromIdPerifl = value;
			}
		}
