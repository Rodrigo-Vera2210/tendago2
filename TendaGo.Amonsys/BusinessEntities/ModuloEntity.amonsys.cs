...
namespace ER.BE
{
    ...
    [System.Serializable] 
    public partial class ModuloEntityBase : EntityStatesManager
    
    {
		...
		public const string Modulo_EntityColumn = "Modulo";
		...
		/// <summary> 
		/// Get or sets a obligatory value of Modulo. 
		/// </summary>
		public virtual string Modulo
		{
			...
			set
			{
				if (_modulo != value && CurrentState != EntityStatesEnum.New && CurrentState != EntityStatesEnum.Deleted)
				{
					CurrentState = EntityStatesEnum.Updated;
				}
				_modulo = value;
        ...
        public ModuloEntityBase ()
        {
            SetNewState();
        }
        
        
        internal ModuloEntity CopyBase()
        {
          ModuloEntity copy = new ModuloEntity();
          copy.Id = this.Id;
...
#region << Children >>
		...
		private PantallaEntityCollection _PantallaFromIdModulo;

		public virtual PantallaEntityCollection PantallaFromIdModulo
		{
			get
			{
				return _PantallaFromIdModulo;
			}
			set
			{
				_PantallaFromIdModulo = value;
			}
		}
