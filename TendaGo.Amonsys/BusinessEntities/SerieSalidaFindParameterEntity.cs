...
{
    [System.Serializable]
    public partial class SerieSalidaFindParameterEntity
    {
        #region << Atributtes >>
		...
		public bool IsValid(SerieSalidaEntity _entity)
		{
			...
			if (!String.IsNullOrEmpty(this.IdDetalleSalida))
			{
				if (this.IdDetalleSalida != _entity.IdDetalleSalida)
				{
					return false;
				}
			}
