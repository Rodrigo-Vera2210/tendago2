    ...
    public partial class TipoPaqueteUIAdapter
    {
       ...
       public static TipoPaqueteEntity Save(TipoPaqueteEntity tipoPaquete)
       {
            try
            {
              ...
              return TipoPaqueteBussinesAction.Save(tipoPaquete);
        ...
        public static TipoPaqueteEntity LoadByPK(int Id)
        {
            try
            {
              ...
              return TipoPaqueteBussinesAction.LoadByPK(Id);
        ...
        public static TipoPaqueteEntity LoadByPK(int Id , int deepLoadLevel)
        {
            try
            {
              ...
              return TipoPaqueteBussinesAction.LoadByPK(Id, deepLoadLevel );
