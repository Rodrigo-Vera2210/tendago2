...
namespace ER.UIAdapter
{
    public partial class LocalBodegaCollectionUIAdapter
    {
        ...
        public static LocalBodegaFindParameterEntity CreateNewFindParameter()
        {
        	return new LocalBodegaFindParameterEntity();
        }
        ...
        public static LocalBodegaEntityCollection Save(LocalBodegaEntityCollection localBodegaCollection )
        {
            ...
            try
            {
              ...
              return LocalBodegaCollectionBussinesAction.Save(localBodegaCollection);
        ...
        public static LocalBodegaEntityCollection FindByAll(LocalBodegaFindParameterEntity findParameter ,int deepLoadLevel)
        {
            try
            {
              ...
              return LocalBodegaCollectionBussinesAction.FindByAll( findParameter, deepLoadLevel);
        ...
        public static LocalBodegaEntityCollection FindByAllPaged(LocalBodegaFindParameterEntity findParameter ,int pageNumber, int pageSize , string orderBy, int deepLoadLevel)
        {
            try
            {
              ...
              return LocalBodegaCollectionBussinesAction.FindByAllPaged( findParameter,pageNumber,pageSize,orderBy,deepLoadLevel);
