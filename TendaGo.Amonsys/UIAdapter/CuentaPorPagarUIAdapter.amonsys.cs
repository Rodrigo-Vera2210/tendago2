    ...
    public partial class CuentaPorPagarUIAdapter
    {
       ...
       public static CuentaPorPagarEntity Save(CuentaPorPagarEntity cuentaPorPagar)
       {
            try
            {
              ...
              return CuentaPorPagarBussinesAction.Save(cuentaPorPagar);
        ...
        public static CuentaPorPagarEntity LoadByPK(int Id)
        {
            try
            {
              ...
              return CuentaPorPagarBussinesAction.LoadByPK(Id);
        ...
        public static CuentaPorPagarEntity LoadByPK(int Id , int deepLoadLevel)
        {
            try
            {
              ...
              return CuentaPorPagarBussinesAction.LoadByPK(Id, deepLoadLevel );
