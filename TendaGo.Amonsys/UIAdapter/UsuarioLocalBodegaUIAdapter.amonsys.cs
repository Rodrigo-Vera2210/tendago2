    ...
    public partial class UsuarioLocalBodegaUIAdapter
    {
       ...
       public static UsuarioLocalBodegaEntity Save(UsuarioLocalBodegaEntity usuarioLocalBodega)
       {
            try
            {
              ...
              return UsuarioLocalBodegaBussinesAction.Save(usuarioLocalBodega);
        ...
        public static UsuarioLocalBodegaEntity LoadByPK(int Id)
        {
            try
            {
              ...
              return UsuarioLocalBodegaBussinesAction.LoadByPK(Id);
        ...
        public static UsuarioLocalBodegaEntity LoadByPK(int Id , int deepLoadLevel)
        {
            try
            {
              ...
              return UsuarioLocalBodegaBussinesAction.LoadByPK(Id, deepLoadLevel );
