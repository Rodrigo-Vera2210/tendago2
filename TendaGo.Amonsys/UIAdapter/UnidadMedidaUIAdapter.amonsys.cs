    ...
    public partial class UnidadMedidaUIAdapter
    {
       ...
       public static UnidadMedidaEntity Save(UnidadMedidaEntity unidadMedida)
       {
            try
            {
              ...
              return UnidadMedidaBussinesAction.Save(unidadMedida);
        ...
        public static UnidadMedidaEntity LoadByPK(int Id)
        {
            try
            {
              ...
              return UnidadMedidaBussinesAction.LoadByPK(Id);
        ...
        public static UnidadMedidaEntity LoadByPK(int Id , int deepLoadLevel)
        {
            try
            {
              ...
              return UnidadMedidaBussinesAction.LoadByPK(Id, deepLoadLevel );
