    ...
    public partial class DetalleCobroUIAdapter
    {
       ...
       public static DetalleCobroEntity Save(DetalleCobroEntity detalleCobro)
       {
            try
            {
              ...
              return DetalleCobroBussinesAction.Save(detalleCobro);
        ...
        public static DetalleCobroEntity LoadByPK(int Id)
        {
            try
            {
              ...
              return DetalleCobroBussinesAction.LoadByPK(Id);
        ...
        public static DetalleCobroEntity LoadByPK(int Id , int deepLoadLevel)
        {
            try
            {
              ...
              return DetalleCobroBussinesAction.LoadByPK(Id, deepLoadLevel );
