...
namespace ER.UIAdapter
{
    public partial class PresupuestoFacturacionCollectionUIAdapter
    {
        ...
        public static PresupuestoFacturacionFindParameterEntity CreateNewFindParameter()
        {
        	return new PresupuestoFacturacionFindParameterEntity();
        }
        ...
        public static PresupuestoFacturacionEntityCollection Save(PresupuestoFacturacionEntityCollection presupuestoFacturacionCollection )
        {
            ...
            try
            {
              ...
              return PresupuestoFacturacionCollectionBussinesAction.Save(presupuestoFacturacionCollection);
        ...
        public static PresupuestoFacturacionEntityCollection FindByAll(PresupuestoFacturacionFindParameterEntity findParameter ,int deepLoadLevel)
        {
            try
            {
              ...
              return PresupuestoFacturacionCollectionBussinesAction.FindByAll( findParameter, deepLoadLevel);
        ...
        public static PresupuestoFacturacionEntityCollection FindByAllPaged(PresupuestoFacturacionFindParameterEntity findParameter ,int pageNumber, int pageSize , string orderBy, int deepLoadLevel)
        {
            try
            {
              ...
              return PresupuestoFacturacionCollectionBussinesAction.FindByAllPaged( findParameter,pageNumber,pageSize,orderBy,deepLoadLevel);
