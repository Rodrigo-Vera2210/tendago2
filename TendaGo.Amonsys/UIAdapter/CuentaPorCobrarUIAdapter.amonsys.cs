    ...
    public partial class CuentaPorCobrarUIAdapter
    {
       ...
       public static CuentaPorCobrarEntity Save(CuentaPorCobrarEntity cuentaPorCobrar)
       {
            try
            {
              ...
              return CuentaPorCobrarBussinesAction.Save(cuentaPorCobrar);
        ...
        public static CuentaPorCobrarEntity LoadByPK(int Id)
        {
            try
            {
              ...
              return CuentaPorCobrarBussinesAction.LoadByPK(Id);
        ...
        public static CuentaPorCobrarEntity LoadByPK(int Id , int deepLoadLevel)
        {
            try
            {
              ...
              return CuentaPorCobrarBussinesAction.LoadByPK(Id, deepLoadLevel );
