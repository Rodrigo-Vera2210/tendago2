...
{
    public partial class DetalleSalidaCollectionUIAdapter
    {
        ...
        public static DetalleSalidaFindParameterEntity CreateNewFindParameter()
        {
        	return new DetalleSalidaFindParameterEntity();
        }
        ...
        public static DetalleSalidaEntityCollection Save(DetalleSalidaEntityCollection detalleSalidaCollection )
        {
            ...
            try
            {
              ...
              return DetalleSalidaCollectionBussinesAction.Save(detalleSalidaCollection);
        ...
        public static DetalleSalidaEntityCollection FindByIdSalida(string idSalida)
        {


            return FindByAll(new DetalleSalidaFindParameterEntity { IdSalida = idSalida }, 1);
        ...
        public static DetalleSalidaEntityCollection FindByAll(DetalleSalidaFindParameterEntity findParameter ,int deepLoadLevel)
        {
            try
            {
              ...
              return DetalleSalidaCollectionBussinesAction.FindByAll( findParameter, deepLoadLevel);
        ...
        public static DetalleSalidaEntityCollection FindByAllPaged(DetalleSalidaFindParameterEntity findParameter ,int pageNumber, int pageSize , string orderBy, int deepLoadLevel)
        {
            try
            {
              ...
              return DetalleSalidaCollectionBussinesAction.FindByAllPaged( findParameter,pageNumber,pageSize,orderBy,deepLoadLevel);
