...
namespace ER.UIAdapter
{
    public partial class UnidadMedidaCollectionUIAdapter
    {
        ...
        public static UnidadMedidaFindParameterEntity CreateNewFindParameter()
        {
        	return new UnidadMedidaFindParameterEntity();
        }
        ...
        public static UnidadMedidaEntityCollection Save(UnidadMedidaEntityCollection unidadMedidaCollection )
        {
            ...
            try
            {
              ...
              return UnidadMedidaCollectionBussinesAction.Save(unidadMedidaCollection);
        ...
        public static UnidadMedidaEntityCollection FindByAll(UnidadMedidaFindParameterEntity findParameter ,int deepLoadLevel)
        {
            try
            {
              ...
              return UnidadMedidaCollectionBussinesAction.FindByAll( findParameter, deepLoadLevel);
        ...
        public static UnidadMedidaEntityCollection FindByAllPaged(UnidadMedidaFindParameterEntity findParameter ,int pageNumber, int pageSize , string orderBy, int deepLoadLevel)
        {
            try
            {
              ...
              return UnidadMedidaCollectionBussinesAction.FindByAllPaged( findParameter,pageNumber,pageSize,orderBy,deepLoadLevel);
