...
namespace ER.UIAdapter
{
    public partial class PrecioCollectionUIAdapter
    {
        ...
        public static PrecioFindParameterEntity CreateNewFindParameter()
        {
        	return new PrecioFindParameterEntity();
        }
        ...
        public static PrecioEntityCollection Save(PrecioEntityCollection precioCollection )
        {
            ...
            try
            {
              ...
              return PrecioCollectionBussinesAction.Save(precioCollection);
        ...
        public static PrecioEntityCollection FindByAll(PrecioFindParameterEntity findParameter ,int deepLoadLevel)
        {
            try
            {
              ...
              return PrecioCollectionBussinesAction.FindByAll( findParameter, deepLoadLevel);
        ...
        public static PrecioEntityCollection FindByAllPaged(PrecioFindParameterEntity findParameter ,int pageNumber, int pageSize , string orderBy, int deepLoadLevel)
        {
            try
            {
              ...
              return PrecioCollectionBussinesAction.FindByAllPaged( findParameter,pageNumber,pageSize,orderBy,deepLoadLevel);
