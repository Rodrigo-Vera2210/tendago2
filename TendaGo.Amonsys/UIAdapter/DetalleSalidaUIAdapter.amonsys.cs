    ...
    public partial class DetalleSalidaUIAdapter
    {
       ...
       public static DetalleSalidaEntity Save(DetalleSalidaEntity detalleSalida)
       {
            try
            {
              ...
              return DetalleSalidaBussinesAction.Save(detalleSalida);
        ...
        public static DetalleSalidaEntity LoadByPK(string Id)
        {
            try
            {
              ...
              return DetalleSalidaBussinesAction.LoadByPK(Id);
        ...
        public static DetalleSalidaEntity LoadByPK(string Id , int deepLoadLevel)
        {
            try
            {
              ...
              return DetalleSalidaBussinesAction.LoadByPK(Id, deepLoadLevel );
