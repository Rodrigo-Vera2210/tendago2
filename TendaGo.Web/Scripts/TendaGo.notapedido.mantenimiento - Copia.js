var NotaPedidoMant = function () {
    ...
    function recalcularMetodos(element) {
        ...
        //var valrec = 0.00;
        //valrec = document.getElementById('recibovalor').value;        
...
/*        cobros = parseFloat(cobros.toFixed(2)) + parseFloat(valrec);*/
    ...
    var saveAction = function (e) {
        ...
        if ($valid_form) {
            ...
            if (($accion == "Entregar" || entregaInmediata == "True") && validarAnticipos()) {
                return false;
            }
    ...
    var validarAnticipos = function () {
        ...
        var valorTotal = $("#Total").toFloat();
        var valorAbono = $("#ValorAbono").toFloat() + $("#recibovalor").toFloat();
