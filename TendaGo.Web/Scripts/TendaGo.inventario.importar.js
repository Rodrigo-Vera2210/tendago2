var AjuImport = function () {
    ...
    var
        import_main = function () {
            ...
            $("#formImpAjuste").on("submit", function (event) {
                ...
                var formGuardarCompra = $("#formImpAjuste");
                ...
                $.ajax({
                    ...
                    if (respuesta != "") {
                        if (respuesta.success == true) {
                            ...
                            toastr.warning(respuesta.message, "", optionsToastr);
            ...
            $("#formImpAjuste").purchaseWizard();
        },



        setProvidersSettings = function () {
            providers.searchControl.url = AjuImport.SearchSupplierUrl;
            ...
            providers.createControl.url = AjuImport.CreateSupplierUrl;
        ...
        UploadExcel = function () {            
            ...
            if (fileInput.files.length !== 0) {
                ...
                if (extension !== "XLS" && extension !== "XLSX") {
                    ...
                    var $div = $("#formImpAjuste");                    
                    $.ajax({
                        url: AjuImport.ImportExcelUrl,
                        type: 'POST',
                        data: formdata,
                        //async: false,
                        async: true,
        ...
        nextValidationFunc = function onNextValidation($tab, $navigation, index) {
            ...
            if (index === 2) {
                var formToValidate = $("#formImpAjuste");
        ...
        Reset = function () {
            ...
            setTimeout(function () {
                ...
                unblockUI($div);
                $div.removeClass('loading');
                document.getElementById("formImpAjuste").reset();
